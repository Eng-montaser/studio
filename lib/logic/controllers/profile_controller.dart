...
// import 'package:pos/database/user_db.dart';
...
//     UserDb().getUserAccountData().then((value){
//       if(value.success){
...
//       return userData;
//     }
//   saveLoginData(username,password)async {
//     getDataLoading.value=true;
//     UserDb().login(username, password).then((value){
//       if(value.success){
//         _userData=value.userData;
//       }else{
//
...
//   //         sendDataLoading.value = false;
//   //         update();
//   //            GetMessageError(context,  "unknown error".tr);
//   //       }
//   //     });
//   //     // catch (e) {
