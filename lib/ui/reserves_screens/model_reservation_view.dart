...
class ModelReservationView extends StatefulWidget {
  const ModelReservationView({Key? key}) : super(key: key);

  @override
  _ContactUsState createState() => _ContactUsState();
}

class _ContactUsState extends State<ModelReservationView> {
  List<String> data1=[
    'توثق اول لحظات طفلك من الحمل الى مابعد الولادة',
    '- ثلاث جلسات تصوير',
  ];
  List<String> data2=[
    'توثق اول لحظات طفلك من الحمل الى مابعد الولادة توثق اول لحظات طفلك من الحمل الى مابعد الولادة',
    '- ثلاث جلسات تصوير',
  ];
  @override
                        ...
                        Container(
                          ...
                          decoration: const BoxDecoration(
                              image: DecorationImage(
                                  image: AssetImage('assets/images/wedding_home1.jpg'),
                                  fit: BoxFit.cover
                              ),
