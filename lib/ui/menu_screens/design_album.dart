...
class DesignAlbum extends StatefulWidget {
  const DesignAlbum({Key? key}) : super(key: key);

  @override
  _DesignAlbumState createState() => _DesignAlbumState();
}

class _DesignAlbumState extends State<DesignAlbum> {
