...
import 'package:studio/ui/menu_screens/reserves_screens/confirm_reservation_view.dart';
import 'package:studio/ui/menu_screens/reserves_screens/terms_reservation_view.dart';
              ...
              Padding(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      if(widget.detailsList.isNotEmpty)
                        ...List.generate(widget.detailsList.length, (index) =>
                            Container(
