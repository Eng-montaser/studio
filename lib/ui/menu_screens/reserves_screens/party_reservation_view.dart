...
class PartyReservationView extends StatefulWidget {
  const PartyReservationView({Key? key}) : super(key: key);

  @override
  _ContactUsState createState() => _ContactUsState();
}

class _ContactUsState extends State<PartyReservationView> {
  List<String> data1 = [
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                              ...
                              padding:
                                  FCIPadding.symmetric(width: 10, height: 20),
                              decoration: BoxDecoration(
                                color: Colors.white,
                                borderRadius:
